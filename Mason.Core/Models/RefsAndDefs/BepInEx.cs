...
namespace Mason.Core.RefsAndDefs
{
	internal class BepInExRefs
	{
		public BepInExRefs(ModuleDefinition bepInEx)
		{
			...
			BepInDependencyCtorWithFlags =
				bepindep.FindMethodSafe("System.Void .ctor(System.String,BepInEx.BepInDependency/DependencyFlags)");

			BepInDependencyDependencyFlagsType = bepInEx.GetTypeSafe("BepInEx.BepInDependency/DependencyFlags");

			BepInIncompatibilityCtor =
				bepInEx.GetTypeSafe("BepInEx.BepInIncompatibility").FindMethodSafe("System.Void .ctor(System.String)");
